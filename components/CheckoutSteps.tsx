...
export default function CheckoutSteps({ currentStep }: CheckoutStepsProps) {
  ...
  return (
    <div className="flex items-center justify-between max-w-xl mx-auto mt-8 mb-12 relative px-4">
      {/* Background Line */}
      <div className="absolute left-[20%] right-[20%] top-6 h-0.5 bg-gray-100 -z-10"></div>
      
      {/* Active Line (Progress) */}
      <div 
        className="absolute left-[20%] top-6 h-0.5 bg-gray-900 transition-all duration-500 ease-in-out -z-10"
        style={{ width: currentStep === 1 ? '0%' : '60%' }}
      ></div>
