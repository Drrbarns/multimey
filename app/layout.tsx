...
const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'MultiMey Supplies';
const siteDescription = process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'Your one-stop online store.';
